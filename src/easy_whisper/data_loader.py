...
def load_local_dataset(
    ...
    if audio is not None and transcription is not None:
        ...
        try:
            ...
            if "transcription" in dataset["train"].column_names and "sentence" not in dataset["train"].column_names:
        ...
        try:
            ...
            try:
                ...
                with open(metadata_path, 'r', newline='', encoding='utf-8') as csvfile:
                    ...
                    text_col = "transcription" if "transcription" in reader.fieldnames else "sentence"
            ...
            audio_paths = [os.path.join(dataset_dir, file_name) for file_name in file_names]
